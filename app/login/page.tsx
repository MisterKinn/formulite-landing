                    ...
                    <div className="social-login-container">
                        ...
                        >
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M10 2C5.029 2 1 5.214 1 9.166c0 2.522 1.671 4.741 4.195 6.016-.185.68-.67 2.464-.767 2.846-.12.47.173.464.364.337.15-.1 2.383-1.62 3.35-2.28.278.04.562.061.858.061 4.971 0 9-3.214 9-7.18C18 5.214 14.971 2 10 2z" fill="#000"/>
                            </svg>
                            <span>카카오로 계속하기</span>
                        </button>
                        <button
                        ...
                        >
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M13.54 10.647L6.18 2H2v16h4.46V9.353L13.82 18H18V2h-4.46v8.647z" fill="#fff"/>
                            </svg>
                            <span>네이버로 계속하기</span>
                        </button>
                        <button
                        ...
                        >
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <g clipPath="url(#clip0_993_771)">
                                    <path d="M19.805 10.2305C19.805 9.55078 19.7483 8.86719 19.6267 8.19922H10.2V12.0508H15.6408C15.4158 13.2812 14.6725 14.3359 13.6242 15.0352V17.2852H16.7283C18.5275 15.6172 19.805 13.1953 19.805 10.2305Z" fill="#4285F4"/>
                                    <path d="M10.2 20C12.6992 20 14.7892 19.1797 16.3283 17.2852L13.6242 15.0352C12.7892 15.6016 11.6425 15.9609 10.2 15.9609C7.78917 15.9609 5.74917 14.2734 5.035 12.0508H1.82831V14.375C3.41748 17.6016 6.59917 20 10.2 20Z" fill="#34A853"/>
                                    <path d="M5.035 12.0508C4.85165 11.4844 4.74831 10.8828 4.74831 10.25C4.74831 9.61719 4.85165 9.01562 5.035 8.44922V6.125H1.82831C1.20165 7.36719 0.845001 8.75781 0.845001 10.25C0.845001 11.7422 1.20165 13.1328 1.82831 14.375L5.035 12.0508Z" fill="#FBBC05"/>
                                    <path d="M10.2 4.53906C11.4842 4.53906 12.6408 4.98438 13.5408 5.83594L16.3933 3.04688C14.7858 1.52344 12.6958 0.5 10.2 0.5C6.59917 0.5 3.41748 2.89844 1.82831 6.125L5.035 8.44922C5.74917 6.22656 7.78917 4.53906 10.2 4.53906Z" fill="#EA4335"/>
                                </g>
                                <defs>
