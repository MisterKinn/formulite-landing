            ...
            <div className="section-inner">
                ...
                <div className="pricing-grid">
                    {plans.map((plan, index) => (
                        <div
                            key={plan.name}
                            className={`pricing-card-new ${plan.popular ? "pricing-card-popular" : ""}`}
                        >
                            {plan.popular && <span className="pricing-badge">BEST</span>}
                            <div className="pricing-card-content">
                                ...
                                <p className="pricing-plan-subdesc">{plan.subDescription}</p>
